...
<template>
  <main @mousemove="mousemove" v-if="start">
    <div id="mainpad">
      <div id="wr">
        <h1>KI: <br/> Zeichen <br/> Zauber</h1>
        <h3>
          Erweitere deine Kreativität! <br/>
          Zeichne mit deinem Finger,<br/> schreibe, wie es aussehen soll<br/>
           und die KI “zaubert” ein Bild heraus.
        </h3>
        <CusButton text="Zeichnen" @click="$router.push('draw'); start = false;"></CusButton>
      </div>
    </div>
